...
export const mockEvents: CalendarEvent[] = [
  ...
  { id: "ev-18", title: "连续会议缓冲", type: "buffer", day: 2, startHour: 15.75, duration: 0.25, priority: "P4", status: "scheduled", movable: true, fixed: false, flexible: true, energyLevel: "low", aiGenerated: false },
