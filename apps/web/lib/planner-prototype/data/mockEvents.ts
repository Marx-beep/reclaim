...
export const mockTasks: TaskItem[] = [
  ...
  { id: "task-slides", title: "做答辩 PPT", priority: "P1", dueDate: "2026-05-14 17:00", dueDay: 4, dueHour: 17, estimatedMinutes: 120, remainingMinutes: 120, status: "scheduled", upNext: false, energyLevel: "medium", splittable: true },
...
export const mockMeetings: SmartMeetingItem[] = [
  ...
  { id: "meeting-client", title: "客户评审", attendees: ["客户", "导师", "你"], frequency: "一次性", durationHours: 1, priority: "P1", scheduledDay: 3, scheduledHour: 11.25, conflictStatus: "正常", active: true, linkedEventId: "ev-21" }
];
...
export const mockEvents: CalendarEvent[] = [
  { id: "ev-01", title: "晨间规划", type: "habit", day: 0, startHour: 8, duration: 0.5, priority: "P3", status: "scheduled", movable: true, fixed: false, flexible: true, energyLevel: "low", aiGenerated: false },
  ...
  { id: "ev-04", title: "午餐", type: "break", day: 0, startHour: 12.25, duration: 0.75, priority: "P4", status: "scheduled", movable: false, fixed: true, flexible: false, energyLevel: "low", aiGenerated: false },
  { id: "ev-05", title: "日历缓冲", type: "buffer", day: 0, startHour: 14, duration: 0.5, priority: "P4", status: "scheduled", movable: false, fixed: true, flexible: false, energyLevel: "low", aiGenerated: false },
  ...
  { id: "ev-08", title: "午餐", type: "break", day: 1, startHour: 12.5, duration: 0.75, priority: "P4", status: "scheduled", movable: false, fixed: true, flexible: false, energyLevel: "low", aiGenerated: false },
  ...
  { id: "ev-11", title: "恢复缓冲", type: "buffer", day: 1, startHour: 16.75, duration: 0.5, priority: "P4", status: "scheduled", movable: false, fixed: true, flexible: false, energyLevel: "low", aiGenerated: false },
  ...
  { id: "ev-16", title: "午餐", type: "break", day: 2, startHour: 12.75, duration: 0.75, priority: "P4", status: "scheduled", movable: false, fixed: true, flexible: false, energyLevel: "low", aiGenerated: false },
  { id: "ev-17", title: "撰写提案大纲", type: "task", day: 2, startHour: 14, duration: 1.5, priority: "P2", status: "scheduled", movable: true, fixed: false, flexible: true, energyLevel: "high", aiGenerated: false, taskId: "task-outline" },
  { id: "ev-18", title: "连续会议缓冲", type: "buffer", day: 2, startHour: 15.75, duration: 0.25, priority: "P4", status: "scheduled", movable: false, fixed: true, flexible: false, energyLevel: "low", aiGenerated: false },
  ...
  { id: "ev-22", title: "午餐", type: "break", day: 3, startHour: 12.5, duration: 0.75, priority: "P4", status: "scheduled", movable: false, fixed: true, flexible: false, energyLevel: "low", aiGenerated: false },
  ...
  { id: "ev-26", title: "保护专注块", type: "focus", day: 4, startHour: 8.75, duration: 1.5, priority: "P1", status: "scheduled", movable: true, fixed: false, flexible: true, energyLevel: "high", aiGenerated: false },
  ...
  { id: "ev-28", title: "午餐", type: "break", day: 4, startHour: 12.25, duration: 0.75, priority: "P4", status: "scheduled", movable: false, fixed: true, flexible: false, energyLevel: "low", aiGenerated: false },
  ...
  { id: "ev-32", title: "午餐", type: "break", day: 5, startHour: 12.5, duration: 0.75, priority: "P4", status: "scheduled", movable: false, fixed: true, flexible: false, energyLevel: "low", aiGenerated: false },
  ...
  { id: "ev-35", title: "长距离散步", type: "break", day: 6, startHour: 13.5, duration: 1, priority: "P4", status: "scheduled", movable: false, fixed: true, flexible: false, energyLevel: "low", aiGenerated: false }
];
...
export const initialSuggestions: PlannerSuggestion[] = [
  ...
  { id: "sg-3", title: "把低优先级任务后移", description: "把收尾事项推到周五下午，可以继续为 P1 / P2 任务让出更好的工作时间。", action: { kind: "rebalance" } }
];
